            ...
            <div style={{ textAlign: "center" }} className={styles.Recruit}>
                <div className={styles.formInfo}>
                    <form action="" style={{width:"590px"}}>
                        ...
                        <p className={styles.titleInfo}>Bộ phận tuyển dụng sẽ liên hệ anh (chị) theo số điện thoại đã cung cấp! Trong thời gian chờ anh chị có thể tham khảo thêm Quy trình tuyển dụng <Link>Tại đây.</Link></p>
